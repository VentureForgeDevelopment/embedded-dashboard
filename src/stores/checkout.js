...
export const useCheckoutStore = defineStore("checkout", () => {
  ...
  const state = ref({
    ...
    // Product name markers for extractor: $t("Free") $t("Standard") $t("Growth") $t("Pro")
    // $t() markers below are for the string extractor only (no i18n context in store)
    // Actual translation happens at render time via $t(feature) in CheckoutProduct.vue
    checkout_products_features: {
      Free: [
        /* $t("10,000 Words/Month") */ "10,000 Words/Month",
        /* $t("1 Language") */ "1 Language",
        /* $t("Translation Only") */ "Translation Only",
        /* $t("Multiple Interface Options") */ "Multiple Interface Options",
      ],
      Starter: [
        /* $t("Unlimited Words & Pages") */ "Unlimited Words & Pages",
        /* $t("Bilingual") */ "Bilingual",
        /* $t("SEO Indexing") */ "SEO Indexing",
        /* $t("Meta Data Translation") */ "Meta Data Translation",
        /* $t("Phrase Glossary") */ "Phrase Glossary",
        /* $t("Automatic Content Updates") */ "Automatic Content Updates",
        /* $t("Multiple Interface Options") */ "Multiple Interface Options",
      ],
      Growth: [
        /* $t("Unlimited Words & Pages") */ "Unlimited Words & Pages",
        /* $t("3 languages") */ "3 languages",
        /* $t("Fully Qualified Urls") */ "Fully Qualified Urls",
        /* $t("Deep SEO Indexing") */ "Deep SEO Indexing",
        /* $t("Meta Data Translation") */ "Meta Data Translation",
        /* $t("Text-to-Speech") */ "Text-to-Speech",
        /* $t("Phrase Glossary") */ "Phrase Glossary",
        /* $t("Automatic Content Updates") */ "Automatic Content Updates",
        /* $t("Multiple Interface Options") */ "Multiple Interface Options",
      ],
